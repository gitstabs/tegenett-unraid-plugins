SQLite-backed state management with preserved file operation logic from v2.22d
"""
...
class Config:
    CONFIG_DIR = "/boot/config/plugins/emby_smart_cache"
    DATA_DIR = "/mnt/user/appdata/emby_smart_cache"
    DB_FILE = "state.db"
    ...
    DEFAULTS = {
        "ENABLED": True,
        "EMBY_HOST": "http://192.168.0.30:8096",
        "EMBY_API_KEY": "",
        "DISCORD_WEBHOOK_URL": "",
        "SERVER_PORT": 9999,
        "UNRAID_USER_PATH": "/mnt/user",
        "CACHE_PATH": "/mnt/cache_data",
        "ARRAY_ONLY_PATH": "/mnt/user0",
        "LOG_FILE_PATH": "/mnt/user/appdata/emby_smart_cache/logs/emby_smart_cache.log",
        "RSYNC_BWLIMIT": "50000",
        ...
        "EXCLUDE_PATHS": "",
        "DOCKER_PATH_MAP": "/data/media:/mnt/user/data/media",
...
LOG_FILE = Config.C.get('LOG_FILE_PATH', '/var/log/emby_smart_cache.log')
if os.path.isdir(LOG_FILE):
    LOG_FILE = os.path.join(LOG_FILE, "emby_smart_cache.log")
...
def main():
    ...
    try:
        ...
        if "Address already in use" in str(e):
            ...
            logger.critical("Another instance may be running. Try: pkill -f emby_smart_cache.py")
        else:
